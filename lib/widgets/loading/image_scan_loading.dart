...
class ImageScanLoadingIndicator extends StatefulWidget {
  const ImageScanLoadingIndicator({super.key});

  @override
  State<ImageScanLoadingIndicator> createState() =>
      _ImageScanLoadingIndicatorState();
}

class _ImageScanLoadingIndicatorState extends State<ImageScanLoadingIndicator> {
  double progress = 0.0;
