...
extension MPaginationMetaPatterns on MPaginationMeta {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MPaginationMeta value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _MPaginationMeta() when $default != null:
        return $default(_that.pageSize, _that.totalCount, _that.pageNumber,
            _that.prevPage, _that.nextPage, _that.lastPage);
      case _:
        return orElse();
    }
  }
